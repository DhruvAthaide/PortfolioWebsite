...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Guardient",
    description:
      "A mobile threat defense Android app that detects risky applications using permission intelligence, heuristic risk scoring, cloud-verified file scanning, and an interactive threat dashboard.",
    ...
    status: "completed",
    longDescription:
      "Guardient is a cutting-edge mobile threat defense application developed for Deepcytes Cyber Labs (UK) that analyzes Android apps and files using advanced permission-based heuristics instead of traditional signature-only detection. With its modern interactive dashboard, users gain clear visual insights into installation sources and threat levels. It performs cloud-verified SHA-256 file scanning and evaluates dangerous permission combinations to generate actionable risk scores, ensuring device security while remaining exceptionally lightweight and performance-efficient.",
    features: [
      "Interactive dashboard with visual threat intelligence and installation source tracking",
      "Cloud-verified file scanning using SHA-256 hashes",
      "Permission-based heuristic risk scoring with Risky/Safe filtering",
      "Detection of dangerous permission combinations",
      "Secure app management and source verification",
    ],
    challenges: [
      "Presenting complex threat data and permission intelligence in a user-friendly, accessible format.",
      "Scanning large file systems without impacting device performance.",
      "Identifying risky applications without relying solely on known malware signatures.",
      "Ensuring reliable background execution across different Android versions.",
    ],
    solutions: [
      "Developed a modern, interactive dashboard with donut charts to simplify risk insights for users.",
      "Implemented optimized background scanning using Kotlin Coroutines and Foreground Services.",
      "Designed a heuristic risk-scoring model based on permission combinations and app origins.",
      "Utilized intelligent caching alongside cloud-verified SHA-256 checks to reduce scan overhead.",
    ],
    category: ["Android", "Security"],
  },
  {
